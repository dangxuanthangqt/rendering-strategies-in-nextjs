...
export default function Home() {
  return (
    <main className="flex max-h-screen flex-col items-center justify-between p-8">
      <h2 className="m-2 text-5xl text-cyan-300 font-bold">
        Demonstration of Rendering Strategies in Next.js
      </h2>
      <p className="m-2">
        This is a preview of the article{" "}
        <q>Rendering Strategies in Next.js. </q> You can read the full article
        by clicking this{" "}
